...
GTEST_TEST(librealsense_types_conversion, metadata_conversions) try
{
    ...
    ASSERT_EQ(1,  static_cast<std::underlying_type<rs::core::metadata_type>::type>(rs::core::metadata_type::actual_fps));
    ASSERT_EQ(1,  static_cast<std::underlying_type<rs::frame_metadata>::type>(rs::frame_metadata::actual_fps));
    ...
    ASSERT_EQ(convert(rs::core::metadata_type::actual_fps), rs::frame_metadata::actual_fps);
