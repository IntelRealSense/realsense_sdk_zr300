...
2. Ostro Build 102 - Intel® RealSense™ layers for Yocto build can be found at **TBD**
...
1. The SDK provides recording and playback
    ...
    linux SDK recorder and the windows RSSDK recorder.
