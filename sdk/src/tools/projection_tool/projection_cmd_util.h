...
public:
        ...
        basic_cmd_util(false)
    {
        ...
        add_multy_args_option_safe("-dconf", "set depth profile - [<width>-<height>-<fps>]", 3, '-', "", "628-468-30");
        add_single_arg_option("-dpf", "set depth streams pixel format", "z16", "z16");

        add_multy_args_option_safe("-cconf", "set color stream profile - [<width>-<height>-<fps>]", 3, '-', "", "640-480-30");
        ...
        set_usage_example("-cconf 640-480-30 -cpf rgb8\n\n"
                          ...
                          "Color and Depth streams MUST be available in case of prerecorded clips.\n"
                          "Color, Depth streams and World image are ALWAYS shown.\n"
