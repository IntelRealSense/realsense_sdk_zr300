    ...
    namespace win_file
    {
        namespace conversions
        {
            ...
            core::status convert(stream_type source, rs_stream &target)
            {
                ...
                switch(source)
                {
                    case stream_type::stream_type_color: target = rs_stream::RS_STREAM_COLOR; break;
                    case stream_type::stream_type_depth: target = rs_stream::RS_STREAM_DEPTH; break;
                    case stream_type::stream_type_ir:    target = rs_stream::RS_STREAM_INFRARED; break;
                    case stream_type::stream_type_left:  target = rs_stream::RS_STREAM_INFRARED; break;
                    case stream_type::stream_type_right: target = rs_stream::RS_STREAM_INFRARED2; break;
            ...
            core::status convert(compression_type source, core::file_types::compression_type &target)
            {
                ...
                switch(source)
                {
                    case compression_none: target = core::file_types::compression_type::none; break;
                    case compression_h264: target = core::file_types::compression_type::h264; break;
                    case compression_lzo: target = core::file_types::compression_type::lzo; break;
                    default: return core::status_item_unavailable; break;
                }
                return core::status_no_error;
            }
            ...
            core::status convert(pixel_format source, rs_format &target)
            {
                ...
                switch(source)
                {
                    case 	 pixel_format::pf_any:        target = rs_format::RS_FORMAT_ANY; break;
                    case 	 pixel_format::pf_depth:      target = rs_format::RS_FORMAT_Z16; break;
                    case     pixel_format::pf_depth_f32:  target = rs_format::RS_FORMAT_XYZ32F; break;
                    case 	 pixel_format::pf_yuy2:       target = rs_format::RS_FORMAT_YUYV; break;
                    case 	 pixel_format::pf_rgb24:      target = rs_format::RS_FORMAT_RGB8; break;
                    case 	 pixel_format::pf_rgb32:      target = rs_format::RS_FORMAT_BGRA8; break;
                    case 	 pixel_format::pf_y8:         target = rs_format::RS_FORMAT_Y8; break;
                    case 	 pixel_format::pf_y16:        target = rs_format::RS_FORMAT_Y16; break;
                    case 	 pixel_format::pf_raw:        target = rs_format::RS_FORMAT_RAW10; break;
                    default:                                       return core::status_item_unavailable; break;
                }
                return core::status_no_error;
            }
            ...
            core::status convert(const coordinate_system &source, core::file_types::coordinate_system &target)
            {
                ...
                switch(source)
                {
                    case coordinate_system::coordinate_system_rear_default:  target = core::file_types::coordinate_system::rear_default; break;
                    case coordinate_system::coordinate_system_rear_opencv:   target = core::file_types::coordinate_system::rear_opencv; break;
                    case coordinate_system::coordinate_system_front_default: target = core::file_types::coordinate_system::front_default; break;
            ...
            rs_intrinsics get_intrinsics(stream_type stream, ds_projection::ProjectionData* projection)
            {
                ...
                switch(stream)
                {
                    case stream_type::stream_type_color:
                    {
                    ...
                    case stream_type::stream_type_depth:
                    {
                    ...
                    case stream_type::stream_type_left:
                    {
                    ...
                    case stream_type::stream_type_right:
                    {
