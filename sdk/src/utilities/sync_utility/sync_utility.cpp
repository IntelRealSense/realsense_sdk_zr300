...
rs::utils::sync_utility::~sync_utility()
{
    // Empty and release all image_interface pointers
    ...
    // No need to destroy motion lists since it is structures, and the memory will be freed by destructor automatically
}
