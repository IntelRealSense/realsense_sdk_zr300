...
namespace rs
{
    namespace utils
    {
        class samples_time_sync_trivial_sync : public samples_time_sync_base
        {
        public:
            samples_time_sync_trivial_sync(int streams_fps[static_cast<int>(rs::core::stream_type::max)],
            ...
            virtual ~samples_time_sync_trivial_sync() {}
