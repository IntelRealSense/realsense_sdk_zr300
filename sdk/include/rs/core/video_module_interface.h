        ...
        public:
           ...
           struct supported_motion_sensor_config
           {
            ...
            struct supported_module_config
            {
                 ...
                 *
                 * @param[in] stream                         a stream_type to which a reference to a supported_image_stream_config will be returned.
                 * @return supported_image_stream_config&    the supported image stream configuration.
                 */
                inline supported_image_stream_config& operator[](stream_type stream) { return image_streams_configs[static_cast<uint8_t>(stream)];}

                /**
                 * @brief get a motion config reference by motion type.
                 *
                 * @param[in] motion                          a motion_type to which a reference to a supported_motion_sensor_config will be returned.
                 * @return supported_motion_sensor_config &   the supported motion sensor config.
                 */
            ...
            struct actual_module_config
            {
                 ...
                 * @brief get a stream config reference by stream type.
                 *
                 * @param[in] stream                         a stream_type to which a reference to a actual_image_stream_config will be returned.
                 * @return actual_image_stream_config&       the actual image stream configuration.
                 */
                 ...
                 * @brief get a motion config reference by motion type.
                 *
                 * @param[in] motion                          a motion_type to which a reference to a actual_motion_sensor_config will be returned.
                 * @return actual_motion_sensor_config &      the actual motion sensor config.
                 */
            ...
            public:
                 ...
                 *
                 * @param sender    the cv module which has a ready output.
                 * @param sample    the input sample set that were processed to generate the cv module output data.
                 */
